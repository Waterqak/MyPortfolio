...
const PROJECTS = [
  { title: "Chillin Place", link: "https://www.roblox.com/games/17290214724/Chillin-Place", src: "https://tr.rbxcdn.com/180DAY-c69740761a8556385075f48b5b71147a/768/432/Image/Png/noFilter" },
  { title: "Escape Lava: Collect Brainrots", link: "https://www.roblox.com/games/85862915773488/Escape-Lava-to-collect-brainrots", src: "https://tr.rbxcdn.com/180DAY-1f5e4f49f3ff9eddbf732387c8b19cd7/768/432/Image/Webp/noFilter" },
  { title: "Operation: Azure Rift", link: "https://www.roblox.com/games/140471518514522/Operation-Azure-Rift", src: "https://tr.rbxcdn.com/180DAY-48fa84d77e3cb3cddf71475cd9b09d67/768/432/Image/Webp/noFilter" },
  { title: "Yan-Chan Simulator", link: "https://www.roblox.com/games/90515983274647/Yan-Chan-Simulator", src: "https://tr.rbxcdn.com/180DAY-cae9bb90f7a6e78c66ed1e18af2727e6/768/432/Image/Webp/noFilter" },
];
...
async function loadProfile() {
  ...
  const [user, headshot, followers, friends] = await Promise.all([
    fetchJSON<{ displayName: string; name: string; created: string }>(`https://users.roblox.com/v1/users/${id}`),
    fetchJSON<{ data: { imageUrl: string }[] }>(`https://thumbnails.roblox.com/v1/users/avatar-headshot?userIds=${id}&size=420x420&format=Png`),
...
async function loadGames() {
  ...
  votesRes.data?.forEach((g) => { voteMap[g.id] = { upVotes: g.upVotes, downVotes: g.downVotes }; });
...
Deno.serve(async (req: Request) => {
  ...
  try {
    ...
    return new Response(JSON.stringify({ profile, games }), {
      status: 200,
      headers: { ...corsHeaders, "Content-Type": "application/json", "Cache-Control": "s-maxage=60, stale-while-revalidate=300" },
    });
  } catch (e) {
    console.error("Roblox API error:", e);
    return new Response(JSON.stringify({ error: "Failed to fetch Roblox data" }), {
      status: 500,
